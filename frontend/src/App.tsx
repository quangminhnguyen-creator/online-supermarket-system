      ...
      <section className="hero" aria-labelledby="hero-title">
        <div className="hero__copy">
          ...
          <p className="hero__lead">
            ...
            Nền tảng Sprint 1 đang được kết nối từng phần.
          </p>
        ...
        <aside className="stock-ticket" aria-label="Phiếu kiểm tra nền tảng">
          ...
          <div className="stock-ticket__route">
            ...
            <span>Quầy dịch vụ</span><b>ASP.NET</b>
            <span>Mặt tiền</span><b>React</b>
          </div>
          <div className="stock-ticket__stamp">NỀN TẢNG<br />ĐANG MỞ</div>
        </aside>
      </section>
